...
class _CreditInfoScreenState extends State<CreditInfoScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarWidget(title: 'Credit Info'),
      body: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Text('${widget.credit.paid}\$', style: TextStyle(
                                color: AppColors.black,
                                fontSize: 15,
                                fontWeight: FontWeight.w600),),
                            Text('${widget.credit.totalPayments}\$',
                              style: TextStyle(
                                  color: AppColors.black,
                                  fontSize: 15,
                                  fontWeight: FontWeight.w600),)
                        ...
                        Container(
                          child: LinearPercentIndicator(
                            ...
                            percent: num.parse((widget.credit.paid /
                                widget.credit.totalPayments).toStringAsFixed(2))
                                .toDouble(),
                ...
                children: [
                  Padding(
                    ...
                    child: Row(
                      ...
                      Text('Total payments', style: TextStyle(
                        ...
                        fontSize: 16,
                        fontWeight: FontWeight.w400),),
                    Text('${widget.credit.totalPayments}\$', style: TextStyle(
                        color: AppColors.black,
                        fontSize: 16,
                    ...
                    child: Row(
                      ...
                      children: [
                        Text('Monthly payment', style: TextStyle(
                            ...
                            fontSize: 16,
                            fontWeight: FontWeight.w400),),
                        Text('${widget.credit.monthlyPayment}\$', style: TextStyle(
                            color: AppColors.black,
                            fontSize: 16,
                            fontWeight: FontWeight.w700),),
                      ],
                  ...
                  Padding(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text('Full cost of credit', style: TextStyle(
                            color: AppColors.grey,
                            fontSize: 16,
                            fontWeight: FontWeight.w400),),
                        Text('${widget.credit.fullCost}%', style: TextStyle(
                            color: AppColors.black,
                            fontSize: 16,
                            fontWeight: FontWeight.w700),),
                      ],
                  ...
                  Padding(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text('Overpayment', style: TextStyle(
                            color: AppColors.grey,
                            fontSize: 16,
                            fontWeight: FontWeight.w400),),
                        Text('${widget.credit.overpayment}\$', style: TextStyle(
                            color: AppColors.black,
                            fontSize: 16,
                            fontWeight: FontWeight.w700),),
                      ],
              ...
              Column(
                children: [
                  AppElevatedButton(
                    ...
                    text: 'Add payment',
                    onPressed: () {
                      context.router.push(AddPaymentRoute(creditModel: widget.credit));
                    },
                  ),
                  AppElevatedButton(
